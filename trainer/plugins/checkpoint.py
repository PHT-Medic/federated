...
from client.storage.fs import MinioBuckets, get_minio_fs
...
class MinioCheckpointIO(TorchCheckpointIO):
    ...
    def load_checkpoint(self, path: _PATH, map_location: Optional[Callable] = lambda storage, loc: storage) -> Dict[
        str, Any]:
